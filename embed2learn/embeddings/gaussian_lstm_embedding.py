...
# Begin - Changes (to MLP embedding) for LSTM embedding
import garage.tf.core.layers as L
from garage.tf.core.network import LSTMNetwork
# End - Changes (to MLP embedding) for LSTM embedding
...
class GaussianLSTMEmbedding(StochasticEmbedding, Parameterized, Serializable):
    def __init__(self,
                 embedding_spec,
                 name="GaussianLSTMEmbedding",
                 hidden_sizes=(32, 32),
                 learn_std=True,
                 init_std=1.0,
                 adaptive_std=False,
        ...
        with self._variable_scope:
            with tf.variable_scope("dist_params"):
                ...
                # Begin - Changes (to MLP embedding) for LSTM embedding
                    ...
                    input_dim = self.input_space.flat_dim #TODO: Is flat_dim correct for this?
                    l_feature = L.InputLayer(shape=(None, None, input_dim), input_var=from_input, name="input")
                    use_peepholes = False #TODO: What's the right value for this?
                    
                    mean_std_network = LSTMNetwork(
                    ...
                    # separate LSTMs for mean and std networks
                    # mean network                                        
